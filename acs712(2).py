...
AREF = 3.3  # volt
# sensor vcc = 5 V, but a voltage divider is used to
# get 1.65 V from 2.5 V for the sensor out pin
...
while True:
    ...
    sensor_voltage = (sensor_voltage - DEFAULT_OUTPUT_VOLTAGE) * \
        1000  # unit : milli volt
